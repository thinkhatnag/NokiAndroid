...
describe("New Encounter E2E flow ", () => {
  before(() => {
  ...
  it("First Conversation and Transcript Verification -Es", async () => {
  ...
  it("SOAP Note Generation and Verification for the Draft Conversation -Es", async () => {
    await SpanishLanguage.SOAPNOTE_Verification();
  });
  ...
  it.only("Patient Info Update -Es", async () => {
